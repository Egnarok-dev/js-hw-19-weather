...
function preventDefaultCard() {
  ...
  const defaultApiKey = "1c5ebb32ed25c59e9e50df879a3a77c0";
  const defaultApiUrl = `http://api.weatherstack.com/current?access_key=${defaultApiKey}&query=${defaultCity}`;
  fetch(defaultApiUrl)
...
function onSearchWeather(event) {
  ...
  const apiKey = "1c5ebb32ed25c59e9e50df879a3a77c0";
...
function renderWeatherCard(data) {
  ...
  <div class="card">
    ...
    <div class="main">${ current.temperature }°C</div>
    <div class="mainsub">${ location.name }, ${ location.country }</div>
  ...
  <div class="card2">
    <div class="upper">
      <div class="humidity">
        <div class="humiditytext">Humidity<br>${ current.humidity }%</div>
      ...
      <div class="air">
        <div class="airtext">Wind<br>${ current.wind_speed } Km/h</div>
    ...
    <div class="lower">
      ...
      <div class="realfeel">
        ...
        <div class="realfeeltext">Real Feel<br>${ current.feelslike } °C</div>
      </div>
      ...
      <div class="pressure">
        ...
        <div class="pressuretext">Pressure<br>${current.pressure} mbar</div>
      </div>
      <div class="card3">
      Healthy
      </div>
